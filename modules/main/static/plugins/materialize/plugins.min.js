$(function () {
    ...
    }), $(".scrollspy").scrollSpy(), $(".tooltipped").tooltip({delay: 50}),
    ...
    }), c() && $("#nav-mobile").css({overflow: "auto"}), "undefined" != typeof Chartist && new Chartist.Line("#ct2-chart", {
        labels: [1, 2, 3, 4, 5, 6, 7, 8],
        series: [[5, 9, 7, 8, 5, 3, 5, 4]]
    }, {
        low: 0,
        showArea: !0
    }), 480 >= d && $("#trending-line-chart").attr({height: "200"})
});